...
const giphyKey = 'HB8xLAwjKSgbPF1iq9mSd8cD1EBF7IWz'
...
const urlGiphy = `https://api.giphy.com/v1/gifs/search?q=Paris&app_key=${HB8xLAwjKSgbPF1iq9mSd8cD1EBF7IWz}`

const responsePromise = fetch(urlGiphy)
console.log(responsePromise)
